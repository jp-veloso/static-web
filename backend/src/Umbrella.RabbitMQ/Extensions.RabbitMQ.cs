...
public static partial class Extensions
{
    public static IBasicProperties SetMessageId(this IBasicProperties basicProperties, string messageId = null)
    {
        ...
        basicProperties.MessageId = messageId ?? Guid.NewGuid()
                                                     .ToString("D");
        return basicProperties;
    }

    public static IBasicProperties SetCorrelationId(this IBasicProperties basicProperties,
                                                    IBasicProperties originalBasicProperties)
    {
        if (basicProperties is null)
        {
            throw new ArgumentNullException(nameof(basicProperties));
        ...
        if (originalBasicProperties is null)
        {
    ...
    public static IBasicProperties SetException(this IBasicProperties basicProperties, Exception exception)
    {
        ...
        basicProperties.Headers.Add("exception.type",
                                    $"{exceptionType.Namespace}.{exceptionType.Name}, {exceptionType.Assembly.FullName}");
    ...
    public static bool TryReconstructException(this IBasicProperties basicProperties,
                                               out AmqpRpcRemoteException remoteException)
    {
        ...
        Exception exceptionInstance =
            (Exception) Activator.CreateInstance(Type.GetType(exceptionTypeString) ?? typeof(Exception),
                                                 exceptionMessage);
        remoteException = new AmqpRpcRemoteException("Remote consumer report a exception during execution",
                                                     exceptionStackTrace, exceptionInstance);
        return true;
    }
