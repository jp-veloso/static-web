...
{
    public static Activity SafeStartActivity(this ActivitySource activitySource, [CallerMemberName] string name = "",
    ...
    public static Activity SafeStartActivity(this ActivitySource activitySource, string name, ActivityKind kind,
    ...
    public static IBasicProperties SetTelemetry(this IBasicProperties basicProperties, Activity activity)
    {
        ...
        if (activity != null)
        {
            basicProperties.SetSpanId(activity.SpanId)
    ...
    private static void SetTraceId(this IBasicProperties basicProperties, ActivityTraceId? activityTraceId)
    {
        if (basicProperties is null)
        {
            throw new ArgumentNullException(nameof(basicProperties));
